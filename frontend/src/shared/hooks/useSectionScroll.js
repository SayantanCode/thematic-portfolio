...
export const scrollToSection = (id) => {
  ...
  if (lenis) {
    // Lenis caches document height and clamps scrollTo against it — stale
    // right after a route change swaps in taller content than whatever was
    // last measured (e.g. navigating home from the much shorter /blog),
    // which silently clamps the target short. Forcing a remeasure first
    // keeps this correct regardless of what the previous route looked like.
    lenis.resize();
