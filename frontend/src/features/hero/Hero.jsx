...
import { HERO_DEFAULTS } from "@/constants/siteContent.defaults.js";
        ...
        >
          ...
          <h1 className="font-header font-black leading-tight mb-4 text-[2rem] sm:text-4xl md:text-5xl lg:text-6xl flex flex-wrap items-end justify-center lg:justify-start gap-x-3">
            ...
            {/* delay outlasts MainLayout's 2000ms preloader (+ its own fade-out) —
                ...
                preloader clears. */}
            <ScrambleText text={content.lastName} color={accent} fontSize={nameFontSize} delay={2.4} />
          </h1>
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-10">
            ...
            <Button as="a" href={`mailto:${content.email}`} variant="secondary" icon={<Mail size={18} />}>
              Get In Touch
            </Button>
          </div>
