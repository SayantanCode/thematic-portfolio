...
const DETAIL_ROWS = [
  {
    label: "Name",
    value: "Sayantan Chakraborty",
    icon: <UserRound size={14} />,
  },
  {
    label: "Role",
    value: "Backend-Focused MERN Stack Developer",
            ...
            >
              ...
              <div className="flex-1 pt-1 sm:pt-2 w-full">
                ...
                <CardDescription
                  ...
                  "
                >
                  I love clean code and solving real-world problems — a
                  career switcher who traded the classroom for backend
                  architecture.
                </CardDescription>
